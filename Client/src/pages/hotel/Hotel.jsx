    ...
    <div>
      ...
      {loading ? "Loading Please Wait..." : <div className="hotelContainer">
        ...
        <div className="hotelWrapper">
          <button className="bookNowBtn" onClick={handleClick}>Reserve</button>
          ...
          <span className="hotelDistance">
            Very good location - {data.distance}m from center
          </span>
          <span className="hotelPriceHighlight">
            Book a stay over {data.cheapestPrice}$ at this property and get a free 3 Course
            Meal
          </span>
